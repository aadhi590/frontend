    ...
    <div className="min-h-screen bg-white text-[#1F2937] font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#features"
              className="text-[#6B7280] hover:text-[#1A5F3F] transition-colors font-medium"
            >
              Features
            </a>
            <a
            ...
            {isMounted && (
              <button
                ...
                className="bg-primary-gradient text-white px-6 py-2.5 rounded-full font-semibold hover:scale-105 transition-transform"
              >
                Launch App
              </button>
            )}
      ...
      <section className="relative min-h-screen pt-32 pb-20 bg-primary-gradient flex flex-col items-center justify-center text-center px-6">
        ...
        >
          ...
          >
            <span className="text-[#D4AF37] font-bold tracking-widest text-sm">
              🤝 BANK SAATHI
            </span>
          </motion.div>
          ...
          <motion.h1
            variants={fadeInUp}
            className="font-montserrat font-bold text-5xl md:text-7xl text-white leading-tight mb-6"
          >
            Your Intelligent <br />
          ...
          >
            Works even with incomplete data • Explains every decision •
          ...
          >
            {isMounted && (
              <button
                onClick={handleLaunchApp}
                className="w-full sm:w-auto px-8 py-4 bg-white text-[#1A5F3F] font-bold rounded-full text-lg shadow-xl hover:scale-105 transition-transform flex items-center justify-center gap-2"
              >
            ...
            <button className="w-full sm:w-auto px-8 py-4 bg-transparent text-white border-2 border-white/30 font-bold rounded-full text-lg hover:bg-white/10 transition-colors flex items-center justify-center gap-2">
              Watch Demo{" "}
              <span className="text-white/60 text-sm font-normal">1:23</span>{" "}
              ...
              <div className="w-full h-full bg-[#0F172A] p-6 pt-12 flex flex-col gap-4">
                ...
                <div className="bg-[#1E293B] rounded-2xl p-4 border border-white/5">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="bg-[#F59E0B]/20 text-[#F59E0B] text-[10px] px-2 py-0.5 rounded-full font-bold">
                      Pending
                    </span>
                  </div>
                ...
                <div className="bg-[#F59E0B]/10 border border-[#F59E0B]/20 rounded-2xl p-4">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h4 className="text-[#F59E0B] text-sm font-bold leading-tight">
                        High Risk Alert
                      </h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-white/80 text-[10px] leading-relaxed">
                      Linguistic patterns match recent EMI scams. Incomplete
                      merchant history detected.
                    </p>
                  </div>
                </div>
          ...
          <motion.div variants={fadeInUp} className="mt-20">
            <p className="text-white/40 text-sm font-medium mb-8">
              TRUSTED BY 50K+ INDIANS ACROSS ALL MAJOR BANKS
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-[#6B7280] text-xl max-w-2xl mx-auto">
              Bank Saathi isn't just an app; it's a heuristic shield that
              evolves with the financial threat landscape.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-[#6B7280] text-xl">
              How Bank Saathi secures every capital deployment
            </p>
          </div>
                  ...
                  <div className="flex-1 text-center md:text-right">
                    {idx % 2 === 0 ? (
                      <>
                        ...
                        <p className="text-[#6B7280] leading-relaxed max-w-sm ml-auto">
                          {step.desc}
                        </p>
                      </>
                    ) : (
      ...
      <section id="pricing" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-[#6B7280] text-xl">
              Choose the level of protection that fits your lifestyle
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            >
              <div className="mb-8">
                <span className="text-[#6B7280] font-bold uppercase tracking-widest text-xs">
                  Essential
                </span>
              ...
              <ul className="space-y-4 mb-10 flex-grow">
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#10B981]" /> 50
                  transactions/month
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#10B981]" /> Basic Scam
                  Detection
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#10B981]" /> Community
                  Alerts
                </li>
              </ul>
            ...
            >
              ...
              <ul className="space-y-4 mb-10 flex-grow">
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#D4AF37]" /> Unlimited
                  Transactions
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#D4AF37]" /> Advanced Neural
                  Scrutiny
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#D4AF37]" /> Priority
                  Support
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#D4AF37]" /> Deep
            ...
            >
              ...
              <ul className="space-y-4 mb-10 flex-grow">
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#10B981]" /> Enterprise API
                  Access
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Check size={18} className="text-[#10B981]" /> Custom Risk
                  Thresholds
                </li>
                <li className="flex items-center gap-3 text-sm">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-white/60 text-xl">
                Real stories from the Bank Saathi community
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                quote:
                  "Bank Saathi caught a ₹25K EMI scam before I even realized it was suspicious. The explanation of why it was flagged was crystal clear.",
                author: "Priya S.",
              ...
              {
                quote:
                  "I love how it explains the WHY. It's not just a blocker; it's a teacher that helps me understand modern financial threats.",
                author: "Arjun K.",
              ...
              <div
                key={idx}
                className="bg-white/5 backdrop-blur-md p-10 rounded-[32px] border border-white/10"
              >
      ...
      <footer className="py-20 px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-10">
            ...
            <span className="text-[#1A5F3F]">Financial Future?</span>
          </h2>

          <div className="flex flex-wrap justify-center items-center gap-8 mb-16 text-[#6B7280] font-medium text-sm">
            <span className="flex items-center gap-2">
              <ShieldCheck size={18} className="text-[#1A5F3F]" /> RBI Compliant
            </span>
            <span className="flex items-center gap-2">
              <Lock size={18} className="text-[#1A5F3F]" /> AES-256 Encryption
            </span>
            <span className="flex items-center gap-2">
              <Zap size={18} className="text-[#1A5F3F]" /> 50K+ Active Users
            </span>
          </div>

          <Link
            href="/dashboard"
            className="inline-flex items-center gap-3 px-10 py-5 bg-primary-gradient text-white font-bold rounded-full text-xl shadow-2xl hover:scale-105 transition-transform mb-20"
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-left pt-20 border-t border-gray-100">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                India's leading intelligent financial copilot. Secure,
                evidence-based, and human-centric.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-[#6B7280]">
                <li>
                  <a href="#" className="hover:text-[#1A5F3F]">
                    Features
                  </a>
                </li>
                <li>
          ...
          <div className="mt-20 pt-10 border-t border-gray-100 text-sm text-[#6B7280]">
            © 2026 Bank Saathi Technologies Private Limited. All rights
            reserved.
          </div>
        </div>
      </footer>
